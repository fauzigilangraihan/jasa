        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="animate-slide-in-left">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('services') }}" class="px-8 py-3 bg-secondary text-primary rounded-xl font-bold hover:shadow-lg transition-all hover:scale-105">
                        Lihat Layanan
                    </a>
                    <a href="{{ route('contact') }}" class="px-8 py-3 border-2 border-white text-white rounded-xl font-bold hover:bg-white/10 transition-all">
                        Hubungi Kami
                    </a>
                </div>
            </div>
