    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            ...
            <div class="text-center p-6 bg-white rounded-lg">
                <i class="fas <?php echo e($schedule['icon']); ?> text-3xl text-primary mb-3"></i>
                <p class="font-bold"><?php echo e($schedule['day']); ?></p>
                <p class="text-slate-600"><?php echo e($schedule['time']); ?></p>
            </div>
